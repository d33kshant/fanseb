            ...
            <div className="form">
                {isLogin ? (
                    <>
                        ...
                        <button onClick={sendotp} className="submitbtn">
                            Send OTP
                        </button>
                        <div id="recaptcha"></div>
                        <p style={{ textAlign: "center" }}>
                            You are confirming to our <span style={{ color: "#2597DF" }}>Terms of Use</span> and <span style={{ color: "#2597DF" }}>Privacy Policy</span>
                        </p>
                    </>
                ) : (
                    <>
                        ...
                        <p style={{ color: "rgba(0,0,0,0.4)" }}>
                            Didn't receive code?{" "}
                            <span className="pointer" style={{ color: "blue", fontSize: "10px" }}>
                                Resend OTP
                            </span>
                        </p>
